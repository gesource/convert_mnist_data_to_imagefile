...
def parse_args():
    ...
    parser.add_argument('--image', help='images.idx3-ubyte file path', type=str, default='t10k-images.idx3-ubyte')
    parser.add_argument('--label', help='labels.idx3-ubyte file path', type=str, default='t10k-labels.idx1-ubyte')
